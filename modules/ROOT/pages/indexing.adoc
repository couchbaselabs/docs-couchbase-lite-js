...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="basic-index", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="property-index", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="array-index", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="nested-index", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="multiple-indexes", indent=0]
----
...
[source, typescript]
----
include::example$code_snippets/code_snippets.js[tags="typescript-indexes", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="modify-indexes", indent=0]
----
...
Use query explanations to verify that your indexes are being used:
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="verify-index", indent=0]
----

====

The explanation shows whether an index is used:

* **"Search index..."** - Query uses an index
* **"Scan collection..."** - Query scans all documents (no index used)
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="date-index", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="indexed-query", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="unindexed-query", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="limit-query", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="email-pattern", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="status-pattern", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="date-range-pattern", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="category-pattern", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="performance-test", indent=0]
----
...
1. Check query explanation for "Search index" vs "Scan collection"
2. Verify property name matches index exactly
3. Ensure indexed property is used in WHERE clause
4. Check that query condition is compatible with indexing
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="index-migration", indent=0]
----
