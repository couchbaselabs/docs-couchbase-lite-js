...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="delete-database", indent=0]
----
...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="multiple-databases", indent=0]
----
...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="db-check-storage-quota", indent=0]
----
...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="db-request-persistent-storage", indent=0]
----
...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="database-maintenance", indent=0]
----
...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="collection-change-listener", indent=0]
----
...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="document-change-listener", indent=0]
----
...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="imp-logtape-configure;imp-logtape-consolesink;imp-logcategory;imp-gap;db-increase-log-level", indent=0]
----
