...
[source, javascript]
----
include::example$code_snippets/queries.ts[tags="live-query", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/queries.ts[tags="remove-listener", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/queries.ts[tags="multiple-listeners", indent=0]
----
...
[source, typescript]
----
include::example$code_snippets/queries.ts[tags="typescript-live-query", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/queries.ts[tags="live-query-errors", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/queries.ts[tags="live-query-lifecycle", indent=0]
----
