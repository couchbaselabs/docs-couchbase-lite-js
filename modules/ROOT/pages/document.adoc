...
[source, javascript]
----
include::example$code_snippets/code_snippets.ts[tags="create-and-save-document", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.ts[tags="check-document-properties", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.ts[tags="document-date-handling", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.ts[tags="batch-operations", indent=0]
----
