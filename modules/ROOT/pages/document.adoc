...
[source, javascript]
----
include::example$code_snippets/documents.js[tags="datatype_dictionary", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/documents.js[tags="datatype_array", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/documents.js[tags="document-listener", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/documents.js[tags="document-expiration", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/documents.js[tags="tojson-document", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/documents.js[tags="query-access-json", indent=0]
----
