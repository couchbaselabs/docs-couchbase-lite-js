...
[source, javascript]
----
include::example$code_snippets/code_snippets.ts[tags="doc-create-save", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.ts[tags="doc-check-properties", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.ts[tags="doc-date-handling", indent=0]
----
