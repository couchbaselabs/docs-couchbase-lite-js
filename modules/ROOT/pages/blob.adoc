...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="using-blobs", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="creating-blobs-file-input", indent=0]
----
