...
To enable encryption, provide a password in the https://docs.couchbase.com/mobile/{version-maintenance}/couchbase-lite-js/interfaces/DatabaseConfig.html[DatabaseConfig] when opening the database.
...
To change an existing encryption key, open the database with its current password and use https://docs.couchbase.com/mobile/{version-maintenance}/couchbase-lite-js/classes/Database.html#changeEncryptionKey[Database.changeEncryptionKey()]:
