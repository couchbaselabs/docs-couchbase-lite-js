...
[source, javascript]
----
include::example$code_snippets/code_snippets.ts[tags="imp-logtape-configure;imp-logtape-consolesink;imp-logtape-sinktype;imp-sentry;imp-logcategory;imp-gap;log-sentry-integration", indent=0]
----
====
