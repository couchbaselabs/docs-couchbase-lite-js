...
[source, javascript]
----
include::example$code_snippets/code_snippets.ts[tags="imp-logtape-configure;imp-logtape-consolesink;imp-logtape-asyncsink;imp-logcategory;imp-gap;log-multiple-sinks", indent=0]
----
====
...
NOTE: This example uses the third-party https://www.npmjs.com/package/idb[`idb`] package for IndexedDB access. Install it with `npm install idb`.
...
[source, javascript]
----
include::example$code_snippets/code_snippets.ts[tags="imp-logtape-configure;imp-logtape-asyncsink;imp-logcategory;imp-idb-opendb;imp-gap;log-custom-sink", indent=0]
----
====
...
[source, javascript]
----
include::example$code_snippets/code_snippets.ts[tags="imp-logtape-configure;imp-logtape-consolesink;imp-logtape-asyncsink;imp-logcategory;imp-gap;log-production-setup", indent=0]
----
====
