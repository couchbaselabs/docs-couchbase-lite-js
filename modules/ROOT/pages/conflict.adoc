...
Related Content -- xref:replication.adoc[Remote Sync Gateway] | xref:replication-auth.adoc[Authentication]
--
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="local-win-resolver", indent=0]
----
--
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="remote-win-resolver", indent=0]
----
--
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="merge-resolver", indent=0]
----
--
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="delete-resolver", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="property-merge", indent=0]
----
====
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="field-specific-merge", indent=0]
----
====
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="array-merge", indent=0]
----
====
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="conflict-resolver-config", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="save-conflict-handler", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="custom-merge-save", indent=0]
----
...
[source, typescript]
----
include::example$code_snippets/code_snippets.js[tags="typescript-conflict", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="timestamp-resolution", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="priority-resolution", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="user-resolution", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="test-conflicts", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/code_snippets.js[tags="monitor-conflicts", indent=0]
----
