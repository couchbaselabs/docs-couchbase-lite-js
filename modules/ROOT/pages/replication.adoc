...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="simple-replication", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="config-target", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="config-sync-mode", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="basic-authentication", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="session-authentication", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="custom-headers", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="push-filter", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="pull-filter", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="start-replicator", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="replication-status", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="document-replication-listener", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="pending-documents", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="stop-replicator", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.js[tags="error-handling", indent=0]
----
