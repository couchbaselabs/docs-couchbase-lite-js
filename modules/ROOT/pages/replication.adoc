...
WARNING: Configuring CORS settings for Sync Gateway is a prerequisite for enabling data syncronization with the JavaScript SDK. See xref:cors-configuration.adoc[CORS Configuration] for more details.
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.ts[tags="simple-replication", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.ts[tags="config-target", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.ts[tags="config-sync-mode", indent=0]
----
...
To create a new user, send a POST request to `https://docs.couchbase.com/sync-gateway/current/rest-api/rest_api_admin.html#tag/Database-Security/operation/post_db-_user-[\{db}/_user/\{username}]` with a minimal JSON body:
...
.Using Credentials in Replicator
====
[source, javascript]
----
include::example$code_snippets/code_snippets.ts[tags="replicator-credentials", indent=0]
----
====
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.ts[tags="push-filter", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.ts[tags="pull-filter", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.ts[tags="start-replicator", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.ts[tags="replication-status", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.ts[tags="document-replication-listener", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.ts[tags="pending-documents", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.ts[tags="stop-replicator", indent=0]
----
...
[source, javascript]
----
include::example$code_snippets/replication_snippets.ts[tags="error-handling", indent=0]
----
