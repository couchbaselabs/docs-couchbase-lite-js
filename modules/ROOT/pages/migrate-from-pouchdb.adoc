...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="pouchdb-crud-after", indent=0]
----
====
...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="pouchdb-query-after", indent=0]
----
====
...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="imp-replicator;imp-gap;pouchdb-replication-after", indent=0]
----
====
...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="pouchdb-listener-after", indent=0]
----
====
...
[source,javascript]
----
include::example$code_snippets/code_snippets.ts[tags="pouchdb-listener-correct", indent=0]
----
