...
Couchbase Lite JavaScript runs entirely in the browser, storing data locally using https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API[IndexedDB] and synchronizing with xref:4.0@sync-gateway::introduction.adoc[Sync Gateway] via WebSockets for secure, bi-directional replication.
...
* https://docs.couchbase.com/mobile/{version-maintenance}/couchbase-lite-js/index.html[API{nbsp}References]
